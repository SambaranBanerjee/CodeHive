  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (lastError) {
        ...
        throw new Error("No valid signup endpoint found. Please check your backend routes.");
      }
      
    } catch (err: any) {
      setError(err.message || "An error occurred during signup. Please check if your backend is running and has the correct endpoints.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <form className="space-y-4" onSubmit={handleSignup}>
          ...
          <div className="pt-2">
            ...
            >
              ...
              ) : backendStatus === "offline" ? "Backend Offline" : "Sign Up"}
            </button>
          </div>
        </form>
